...
void solve() {
    string s = "AABAACAADAABAABABBBAFASFASFFASDFASDFDSFSDFSFDSFSAkhglkdsgkldjfkladsjflkjwithwritwirugajdglksajshivans hsionogi sdlfjlk;sadjflk;";
    string patt;
    cin >> patt;
    map<char, int> mp;
    int temp = 64;
    fo(i, 65, 91) mp[(char)i] = i - temp++;
    temp = patt.size() - 1;
    int check = 0;
    int t = 0;
    Rfo(i, temp, -1) check += pow(10, i) * patt[t++];
    int ans = 0;
